...
extern "C" void RadiRedshArray(double spin, double incang, wchar_t *fname,
  ...
  auto Xsc = load_npy<double>("data/data_cache/transit_tmp/Xsc.npy");
  auto Ysc = load_npy<double>("data/data_cache/transit_tmp/Ysc.npy");
  ...
  int Narry = Xshape(0);
  int Narrx = Xshape(1);
  // xt::xarray<double> RadRed = xt::zeros<double>({Narry, Narrx, 3});
...
extern "C" void rdiskLineScr(int nr_zone, double spin, double incang,
  ...
  auto phsc = load_npy<double>("data/data_cache/transit_tmp/phsc.npy");
